...
/**
 * Resizable-array implementation of the Homework4.MyList interface.
 * 
...
public class MyArrayList<E> implements MyList<E>, MyStack<E> {
    ...
    /**
     * Reverses the data in the list. For Homework4.MyArrayList, the data inside the
